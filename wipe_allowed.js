...
const s = `                        <div className="space-y-2">
...
const t = `<p className="text-[10px] text-slate-500">Tüm dosyalar bu dizinin altındaki izinli klasörlere kaydedilecektir.</p>`;
content = content.replace(t, `<p className="text-[10px] text-slate-500">Tüm dosyalar bu ana dizin altında sizin belirleyeceğiniz veya uygulamanın otomatik önereceği (imzadan) klasörlere kaydedilecektir.</p>`);
